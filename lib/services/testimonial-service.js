...
export async function getTestimonials() {
  try {
    return await pjmeDBPrismaClient.Testimonial.findMany({
      select: {
        id: true,
        name: true,
        picture: true,
...
export async function createTestimonial({
  ...
  try {
    ...
    const result = await pjmeDBPrismaClient.Testimonial.create({
      data: {
...
export async function updateTestimonial({
  ...
  try {
    ...
    const result = await pjmeDBPrismaClient.Testimonial.update({
