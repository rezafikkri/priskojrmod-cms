...
export async function createCategory({ name }) {
  ...
  try {
    ...
    const result = await pjmeDBPrismaClient.Category.create({
      data: {
...
export async function deleteCategory(id) {
  ...
  try {
    ...
    const result = await pjmeDBPrismaClient.Category.delete({
      where: { id: parsedId },
      select: { id: true },
    });
...
export async function updateCategory({
  ...
  try {
    ...
    const result = await pjmeDBPrismaClient.Category.update({
