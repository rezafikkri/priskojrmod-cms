    ...
    if (transaction) {
      ...
      return {
        ...
        details: details.map(detail => {
          ...
          if (discountAmount) result.discountAmount = discountAmount;
          if (upgradeCouponAmount) result.upgradeCouponAmount = upgradeCouponAmount;
      ...
      async start(controller) {
        ...
        for (const row of transactions) {
          ...
          stringifier.write({
            ...
            productPrice: row.product_price.toNumber(),
            ...
            upgradeCouponAmount: upgradeCouponAmount ? `-${upgradeCouponAmount}` : '',
