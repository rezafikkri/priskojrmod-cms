...
export async function createProduct({
  ...
  try {
    ...
    if (parsedData.downloadUrl) {
      createData.downloadUrl = parsedData.downloadUrl;
    }
    if (parsedData.driveFileId) {
      createData.driveFileId = parsedData.driveFileId;
    }
...
export async function deleteProduct(id) {
  ...
  try {
    ...
    if (product.isPinned || product.isPublished) {
