...
export async function deleteFaq(id) {
  ...
  try {
    ...
    if (err.name === 'PrismaClientKnownRequestError' && err.code === 'P2025') {
      throw new NotFoundError('Failed to delete the FAQ because it was not found. Please reload the page and try again.');
    }
...
export async function updateFaq({
  ...
  try {
    ...
    if (err.name === 'PrismaClientKnownRequestError' && err.code === 'P2025') {
      throw new NotFoundError('Failed to update the FAQ because it was not found.');
    }
