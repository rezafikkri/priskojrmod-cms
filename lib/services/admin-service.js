...
import { donationLinkIdSchema } from '../validators/account-settings-validator';
...
function getPhoneNumberE164(countryIso, number) {
...
export async function deleteAdmin(id) {
  ...
  try {
    ...
    return await pjmeDBPrismaClient.Admin.delete({
      where: {
        id: parsedId,
