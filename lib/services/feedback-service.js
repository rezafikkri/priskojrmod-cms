...
export async function pullFeedbacks() {
  try {
    ...
    const spreadsheetIndo = new GoogleSpreadsheet(process.env.SPREADSHEET_ID_FEEDBACK_INDO, auth);
    const spreadsheetEn = new GoogleSpreadsheet(process.env.SPREADSHEET_ID_FEEDBACK_EN, auth);
