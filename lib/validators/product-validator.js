import { z } from 'zod';
import { contentCustomSchema, passwordSchema } from './base-validator';
...
const createProductPriceTypeSchema = z.enum(Object.values(PriceType), { message: 'Please select an option' });
...
export const createProductBasicSchema = z.object({
  ...
  admin_id: z.coerce.number().int().gte(1, {
    message: 'Please select an option',
  }).optional(),
...
export const productCouponIdSchema = z.string().uuid();
...
export const productStatusSchema = z.boolean();
