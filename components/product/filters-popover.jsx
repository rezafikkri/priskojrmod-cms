      ...
      >
        <div className="space-y-2 flex items-start gap-4"> 
          <div className="flex-1"> 
            ...
            <p className="text-muted-foreground text-sm">Filter by status</p> 
          </div> 
          <Select
            value={status}
          ...
          > 
            ...
            <SelectContent> 
              <SelectGroup> 
                <SelectItem className="text-base" value="active">Active (Published / Unpublished)</SelectItem> 
                <SelectItem className="text-base" value="inactive">Inactive</SelectItem> 
              </SelectGroup> 
            </SelectContent> 
          </Select> 
        </div> 
